...
beta functional indices. As no package before, it guides the user through 
...
[General_mFD_workflow_vignette](https://cmlmagneville.github.io/mFD_shared/articles/mFD_general_workflow.html).
...
SV, NL and CM coded the functions and their help, except for FUSE computation 
coded by CA and FL. FL, EM, DM, NL and SV contributed to the reflection on 
quality metrics. SV and CM wrote tutorials and improved them based on 
feedbacks of the team. NL, CA, NC, TC, AE, FL, EM, SV and CM tested the 
functions. NC optimized the package and made it ready for CRAN submission.
