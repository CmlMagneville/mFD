...
[Chao _et al._ (2019)](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1343)
allows computing FD based on pairwise distance between species and their weights in
...
functionally equally distinct). Values allowed in `mFD` are "min(imum)", "mean(imum)"
and "max(imum)".
...
💡 For more details about the properties of Hill numbers FD read
[Chao _et al._ (2019)](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1343)
