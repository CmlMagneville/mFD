...
knitr::kable(as.data.frame(baskets_fruits_weights[c(1:6), c(1:6)]), 
      centering = TRUE,
...
💡 **Note that even with** `q = 0`**, weights of species are still accounted for
by FD.** Hence, if the goal is to compute a richness-like index (*i.e.*
accounting only for distance between species present), function
