...
knitr::kable(head(tr_cat_fruits), caption = "Traits types based on **fruits & baskets** dataset")
```
...
```{r}
sp_tr_fruits_summ <- mFD::sp.tr.summary(tr_cat = tr_cat_fruits,    # Traits informations
...
sp_dist_fruits <- mFD::funct.dist(sp_tr = sp_tr_fruits,             # Species x Traits data frame
                           tr_cat       = tr_cat_fruits,         # Traits informations
