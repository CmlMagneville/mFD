...
```{r, results = "hide"}
sp_dist <- mFD::funct.dist(sp_tr       = sp_tr_fruits,             # Species x Traits data frame
...
big_plot <- mFD::funct.space.plot(sp_faxes_coord[ , c("PC1", "PC2", "PC3", "PC4")],
                                  faxes           = NULL,
                                  name_file       = NULL,
                                  faxes_nm        = NULL,
...
big_plot <- mFD::funct.space.plot(sp_faxes_coord,
                                  faxes           = NULL,
                                  name_file       = NULL,
                                  faxes_nm        = NULL,
                                  range_faxes_lim = c(NA, NA),
