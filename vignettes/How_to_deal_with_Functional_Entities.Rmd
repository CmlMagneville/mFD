...
mFD::sp.to.fe(sp_tr = sp_tr_fruits, tr_cat = tr_cat_fruits, fe_nm_type = "fe_rank", check_input = TRUE) 
```
...
```{r}
sp_to_fe_fruits <- mFD::sp.to.fe(sp_tr = sp_tr_fruits, tr_cat = tr_cat_fruits, fe_nm_type = "fe_rank", check_input = TRUE) 
```
