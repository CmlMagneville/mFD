...
vignette: >
  %\VignetteIndexEntry{Compute_and_interpret_quality_of_functional_spaces}
...
```{r, echo = FALSE}
dist_fruits <- mFD::funct.dist(sp_tr = sp_tr, tr_cat = sp_tr_cat, dist_metric = "classical_gower", scaling = 'noscale', stop_if_NA = TRUE)
summary(dist_fruits)
```
