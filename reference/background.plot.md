...
This function creates a ggplot object with customized axes range (same
for both), names and background
...
- range_faxes:
  ...
  have the same range. Default: `range_faxes = c(NA, NA)` (the range is
