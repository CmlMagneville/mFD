...
This function plots FRic index for a given pair of functional axes and
one or several assemblages. It adds convex hull(s), points and vertices
of 1:N assemblages on the background plot
...
- asb_sp_coord2D:
  ...
  each assemblage for a given pair of axes for a given pair of
  functional axes.
...
- color_ch:
  ...
  border of the convex hull filled by the pool of species if one
...
- fill_ch:
  ...
  a R color name or an hexadecimal code referring to the color of convex
  hull filling if one assemblage to plot or a vector of R color names or
...
- alpha_ch:
  ...
  a numeric value referring to the value of transparency of the convex
  hull filling (0 = high transparency, 1 = no transparency) if one
  ...
  formatted as: c(asb1 = "firstRtransparency", asb2 =
  "secondRtransparency", ...).
...
- size_sp:
  ...
  a numeric value referring to the size of the symbol used for species
  plotting if one assemblage to plot or a vector numeric values if
  several assemblages to plot. If more than one assemblage to plot, the
...
- size_vert:
  ...
  a numeric value referring to the size of the symbol used for vertices
  plotting if one assemblage to plot or a vector numeric values if
  several assemblages to plot. If more than one assemblage to plot, the
  vector should be formatted as: c(asb1 = "firstRsize", asb2 =
  "secondRsize", ...).
...
A ggplot object plotting background of multidimensional graphs and FRic
convex hulls.
