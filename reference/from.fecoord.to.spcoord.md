...
- fe_faxes_coord:
  ...
  the data frame gathering FEs coordinates along functional axes, with
  columns representing axes and rows representing FEs.

- asb_sp_w:

  the data frame gathering species\*assemblages, with species in columns
  and assemblages in rows.
...
a data frame gathering species coordinates, with axes being columns and
species being rows. **Note: Works for up to 10 PC**.
