...
segments showing centroid coordinates on functional axes on the
background plot.
...
- asb_fide_coord2D:
  ...
  of the centroid of species for each assemblage for a given pair of
  axes.
...
- color_fide:
  ...
  a R color name or an hexadecimal code referring to the color of
  species centroid for agiven assemblage if one assemblage to plot or a
  vector of R color names or hexadecimal codes if several assemblages to
  plot. If more than one assemblage to plot, the vector should be
