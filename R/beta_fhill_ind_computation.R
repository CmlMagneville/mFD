...
beta.fd.hill <- function(asb_sp_w, sp_dist, 
  ...
  # order q
  mat_res <- matrix(NA, asb_nb, asb_nb, 
                    dimnames = list(asb_nm, asb_nm))
  if (0 %in% q) {
  ...
  for (x in 1:asb_pairs_nb) {
    ...
    if (0 %in% q) 
    {
      ...
      # storing values
      malpha_fd_q$q0[asb_nm_x[2], 
                     asb_nm_x[1]] <- x_malpha_q0
      gamma_fd_q$q0[asb_nm_x[2], 
                    asb_nm_x[1]] <- x_gamma_q0
      beta_fd_q$q0[asb_nm_x[2], 
                   asb_nm_x[1]] <- x_beta_q0
    }  # end of q=0
    ...
    if (1 %in% q) 
    {
      ...
      # storing values
      malpha_fd_q$q1[asb_nm_x[2], 
                     asb_nm_x[1]] <- x_malpha_q1
      gamma_fd_q$q1[asb_nm_x[2], 
                    asb_nm_x[1]] <- x_gamma_q1
      beta_fd_q$q1[asb_nm_x[2], 
                   asb_nm_x[1]] <- x_beta_q1
    ...
    if (2 %in% q) 
    {
      ...
      # storing values
      malpha_fd_q$q2[asb_nm_x[2], 
                     asb_nm_x[1]] <- x_malpha_q2
      gamma_fd_q$q2[asb_nm_x[2], 
                    asb_nm_x[1]] <- x_gamma_q2
      beta_fd_q$q2[asb_nm_x[2], 
                   asb_nm_x[1]] <- x_beta_q2
    }  # end of q=2
