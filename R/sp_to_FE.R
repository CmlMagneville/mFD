...
#'
#' @param sp_tr a \bold{dataframe} with values of traits (columns) for a set of
#' species (rows)
#'
...
#'  }
#'
#' @param fe_nm_type a \bold{character string} referring to the type of naming functional entities.
...
#'
#' @note fe_nm_type = 'tr_val' is allowed \bold{only} if: \itemize{ \item
