...
#'
#' @param deviation_weighting a character string referring to the method(s)
...
#'
#' @param fdist_scaling a vector with logical value(s) specifying whether
...
#'
#' @param fdendro a character string indicating the clustering algorithm to use
